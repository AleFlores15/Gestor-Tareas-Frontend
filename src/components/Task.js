...
const Task = ({ tarea, onTareaActualizada, onTareaEliminada }) => {
  ...
  return (
    <>
      <div
        className={`card mb-4 bg-white shadow-lg ${getBorderColor(
          tarea.estado
        )}`}
        ...
        <div className="card-body">
          ...
          <div className="d-grid gap-2 mt-2">
            ...
            {tarea.estado === "pendiente" && (
              ...
              >
                <i className="bi bi-hourglass-split me-1"></i>Marcar como En
                Progreso
              </button>
            )}
            {tarea.estado === "en progreso" && (
              ...
              >
                <i className="bi bi-check2-circle me-1"></i>Marcar como
                Completada
              </button>
            )}
            {tarea.estado === "completada" && (
